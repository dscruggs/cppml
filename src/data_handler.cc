#include "C:/cygwin64/home/dscru/machine_learning/mnist_ml/include/data_handler.hpp"
...
void data_handler::split_data() //doesn't cannabilize initial data array
{
